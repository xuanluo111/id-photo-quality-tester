[![Playwright Test Report](https://img.shields.io/badge/📊-点击查看最新测试报告-blue?style=for-the-badge)](https://xuanluo111.github.io/id-photo-quality-tester/reports/latest/)
...
2.  在仓库的 **Actions** 标签页中，点击任意工作流记录，在 **deploy summary** 区域点击 `点击查看测试报告` 到测试报告页面。
